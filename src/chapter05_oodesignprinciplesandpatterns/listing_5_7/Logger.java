...
package chapter05_oodesignprinciplesandpatterns.listing_5_7;
...
public class Logger {
	...
	private static Logger myInstance; // by default, this field is initialized
										// to null
	...
	public static Logger getInstance() {
		...
		// return the same object reference any time and every time getInstance
		// is called
		return myInstance;
	}
